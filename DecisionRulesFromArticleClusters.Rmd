...
rpart.cv.fit <- train(y = y, x = x, method = "rpart", trControl = data_ctrl,parms=list(split='information'), tuneGrid = data.frame(cp = c(min.cp, 0.001,0.005, 0.01,  0.05)), control = rpart.control(minsplit = 10, minbucket = 10))
